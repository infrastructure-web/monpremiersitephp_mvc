...
--
-- Hôte : localhost
-- Généré le : mar. 13 juin 2023 à 23:41
...
CREATE TABLE `clients` (
  ...
  `nom_contact` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `prenom_contact` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `clients` (`id`, `nom_entreprise`, `nom_contact`, `prenom_contact`, `telephone`, `adresse`, `ville`, `code_postal`, `province`, `pays`) VALUES
(1, 'Entreprise X', 'Croteau', 'Xarine', '888-888-8888', '123 rue ABC', 'Ville X', 'A0A 0A0', 'Québec', 'Canada'),
(2, 'Entreprise Y', 'Croteau', 'Sylvain', '999-999-9999', '...', '...', '...', '...', '...'),
(3, '...', 'Gosselin', 'Chantal', '..', '..', '..', '..', '..', '..'),
(4, '', 'Arseneault', 'Marc', '', '', '', '', '', '');
...
CREATE TABLE `produits` (
  ...
  `produit` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `produits` (`id`, `code`, `produit`, `prix_coutant`, `prix_vente`, `qte_stock`) VALUES
(20, 'abc', 'Produit abc', 1.00, 2.00, 3),
(23, 'DEF', 'Produit def', 9.00, 8.00, 7);
